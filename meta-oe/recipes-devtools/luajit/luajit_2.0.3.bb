...
EXTRA_OEMAKE_append_x86-64 = ' HOST_CC="${BUILD_CC} -fPIC"'
...
EXTRA_OEMAKE_class-native = 'TARGET_CFLAGS="${BUILD_CFLAGS} -fPIC" TARGET_LDFLAGS="${BUILD_LDFLAGS}" TARGET_SHLDFLAGS="${BUILD_LDFLAGS}" HOST_CC="${BUILD_CC}"'
